...
#End Region
    ...
    Public Function FUNC_GET_FIXED_PHRASE(ByVal strBASE As String) As String
        ...
        strYEAR = Format(datPARM_DATE_BASE.Year, "0000")
        strMONTH = Format(datPARM_DATE_BASE.Month, "00")
        strDAY = Format(datPARM_DATE_BASE.Day, "00")
        strHOUR = Format(datPARM_DATE_BASE.Hour, "00")
        strMINUTE = Format(datPARM_DATE_BASE.Minute, "00")
        strSECOND = Format(datPARM_DATE_BASE.Second, "00")
        strINDEX = Format(intPARM_INDEX, "00000")
