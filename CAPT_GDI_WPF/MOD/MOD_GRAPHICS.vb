...
#Region "構造体"
    Private Structure SRT_CLIENT_IMAGE
        Public RECT As CAPT_COMMON.MOD_PROCESS_WINDOW.RECT
...
#End Region
    ...
    Public Sub SUB_PRINT_WINDOW_TEST(ByRef grpBITMAP As Graphics)
        ...
        Const cstFLAG As Integer = (1 Or 2)
        'Const cstFLAG As Integer = (1)
        ...
        Dim ret As Boolean
        ret = mtdPRINT_WINDOW(prcTARGET.MainWindowHandle, ptrGRAPHIC, cstFLAG)

        Call grpBITMAP.ReleaseHdc(ptrGRAPHIC)
    End Sub

    Public Sub SUB_PRINT_WINDOW_TEST_02(ByRef grpBITMAP As Graphics, ByRef ptrPROCESS As IntPtr, ByVal intFLAG As Integer)
        Dim ptrGRAPHIC As IntPtr
        ...
        Dim ret As Boolean
        ret = mtdPRINT_WINDOW(ptrPROCESS, ptrGRAPHIC, intFLAG)

        Call grpBITMAP.ReleaseHdcInternal(ptrGRAPHIC)
    End Sub
...
#Region "現状未使用"
    ...
    Public Function FUNC_GET_CLIENT_IMAGE() As System.Drawing.Image
...
#End Region
    ...
    Public Function FUNC_GET_CLIENT_DEFAULT_IMAGE(Optional ByVal bln32Bit As Boolean = False) As System.Drawing.Image
        Dim imgRET As System.Drawing.Image
        Dim bmpTEMP As System.Drawing.Bitmap
        Dim pftPIXEL_FORMAT As System.Drawing.Imaging.PixelFormat
        Dim rctPROCESS_CLIENT As CAPT_COMMON.MOD_PROCESS_WINDOW.RECT
        ...
        If bln32Bit Then
            pftPIXEL_FORMAT = System.Drawing.Imaging.PixelFormat.Format32bppRgb '32bit指定
        Else
            pftPIXEL_FORMAT = System.Drawing.Imaging.PixelFormat.Format24bppRgb '24bit指定
        End If
