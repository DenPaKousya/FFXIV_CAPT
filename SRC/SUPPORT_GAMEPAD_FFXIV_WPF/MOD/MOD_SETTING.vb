...
#Region "モジュール用・定数"
    Public Const CST_SETTINGS_GAMEPAD_ALLOCATION_COUNT = 4
#End Region
...
#End Region
    ...
    Friend Sub SUB_SET_SETTINGS(ByRef FRM_SET As FRM_SETTING, ByRef SRT_SET As SRT_SETTINGS)
        With FRM_SET
    ...
    Public Function FUNC_GET_SETTINGS(ByRef CTL_SETTINGS As FRM_SETTING) As SRT_SETTINGS
        ...
        With SRT_RET.GAMEPAD
            ...
            INT_INDEX += 1
            .ALLOCATION(INT_INDEX).BUTTON_01 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_BUTTON_01.SelectedIndex
            .ALLOCATION(INT_INDEX).BUTTON_02 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_BUTTON_02.SelectedIndex
            .ALLOCATION(INT_INDEX).BUTTON_03 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_BUTTON_03.SelectedIndex
            .ALLOCATION(INT_INDEX).KEY_01 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_KEY_01.SelectedIndex
            .ALLOCATION(INT_INDEX).KEY_02 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_KEY_02.SelectedIndex
    ...
    Public Function FUNC_GET_SETTINGS_WPF(ByRef CTL_SETTINGS As WPF_SETTING) As SRT_SETTINGS
        ...
        With SRT_RET.GAMEPAD
            ...
            .ALLOCATION(INT_INDEX).BUTTON_02 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_BUTTON_02.SelectedIndex
            .ALLOCATION(INT_INDEX).BUTTON_03 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_BUTTON_03.SelectedIndex
            .ALLOCATION(INT_INDEX).KIND = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_KIND.SelectedIndex
            .ALLOCATION(INT_INDEX).KEY_01 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_KEY_01.SelectedIndex
            .ALLOCATION(INT_INDEX).KEY_02 = CTL_SETTINGS.CMB_GAMEPAD_ALLOCATION_01_KEY_02.SelectedIndex
            .ALLOCATION(INT_INDEX).MOUSE_X = CTL_SETTINGS.TXT_GAMEPAD_ALLOCATION_01_MOUSE_X.Text
            .ALLOCATION(INT_INDEX).MOUSE_Y = CTL_SETTINGS.TXT_GAMEPAD_ALLOCATION_01_MOUSE_Y.Text
    ...
    Public Sub SUB_REFRESH_GAMEPAD_BUTTON(ByRef FRM_ARG As FRM_SETTING)
        ...
        With FRM_ARG
            ...
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_01_BUTTON_01, STR_ITEMS)
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_01_BUTTON_02, STR_ITEMS)
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_01_BUTTON_03, STR_ITEMS)

            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_02_BUTTON_01, STR_ITEMS)
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_02_BUTTON_02, STR_ITEMS)
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_02_BUTTON_03, STR_ITEMS)

            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_03_BUTTON_01, STR_ITEMS)
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_03_BUTTON_02, STR_ITEMS)
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_03_BUTTON_03, STR_ITEMS)

            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_04_BUTTON_01, STR_ITEMS)
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_04_BUTTON_02, STR_ITEMS)
            Call SUB_REFRESH_COMBO_ITEM(.CMB_GAMEPAD_ALLOCATION_04_BUTTON_03, STR_ITEMS)
        End With
    End Sub
