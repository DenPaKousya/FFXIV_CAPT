...
Partial Class FRM_MAIN
    ...
    Friend WithEvents NTI_TASK As Forms.NotifyIcon
    Friend WithEvents CMS_MENU As Forms.ContextMenuStrip
    Friend WithEvents TSS1 As Forms.ToolStripSeparator
    Friend WithEvents TSM_SETTING As Forms.ToolStripMenuItem
    Friend WithEvents TSS2 As Forms.ToolStripSeparator
    Friend WithEvents TSM_EXIT As Forms.ToolStripMenuItem
    Friend WithEvents TIM_CHECK_PROCESS As Forms.Timer
End Class
