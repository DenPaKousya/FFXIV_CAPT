...
#Region "TAGプロパティ用の固定文字列"
    ...
    Private Const cstTagPlasWord As String = "Plus" '負数チェックを行う
    ...
    Private Const cstTagHalfKanaWord As String = "HalfKana" '半角ｶﾅ
#End Region
                             ...
                             InStr(.Tag, cstTagNumberWord) > 0
                                Select Case chrKeyChar
                                    ...
                                    Case "."
                                        ...
                                        End If
                                    Case "-"
                                        If InStr(.Tag, cstTagPlasWord) > 0 Then
                                            blnHandled = True
                                        Else
                                            'スルー
                                        End If
        ...
        Select Case enmCODE_ERR
            ...
            Case CONTROL_CHECK_ERR_CODE.ErrNotHalfKana
                If strNAME_VALUE = "" Then
                    strRET = "半角カナは入力できません"
                Else
                    strRET = strNAME_VALUE & "には" & "半角カナは入力できません"
                End If
