...
#Region "接頭語・接尾語を基にした変換・探索など"
    ...
    Optional ByVal blnREMOVE_SUFFIX As Boolean = True _
        ...
        Select Case True
            Case TypeOf ctlCONTROL Is System.Windows.Forms.TextBox
                strRET = FUNC_L_REMOVE_STRING(ctlCONTROL.Name, cst_COMMON_CONTROL_PREFIX_TEXTBOX)
                strRET = If(blnREMOVE_SUFFIX, FUNC_REMOVE_SUFFIX(strRET), strRET)
            Case TypeOf ctlCONTROL Is System.Windows.Forms.ComboBox
                strRET = FUNC_L_REMOVE_STRING(ctlCONTROL.Name, cst_COMMON_CONTROL_PREFIX_COMBOBOX)
                strRET = If(blnREMOVE_SUFFIX, FUNC_REMOVE_SUFFIX(strRET), strRET)
            Case TypeOf ctlCONTROL Is System.Windows.Forms.DateTimePicker
                strRET = FUNC_L_REMOVE_STRING(ctlCONTROL.Name, cst_COMMON_CONTROL_PREFIX_DATETIMEPICKER)
                strRET = If(blnREMOVE_SUFFIX, FUNC_REMOVE_SUFFIX(strRET), strRET)
            Case Else
                strRET = ""
        End Select
    ...
    ByVal strMAIN_CONTROL_NAME As String _
        ...
        strRET = cst_COMMON_CONTROL_PREFIX_LABEL & strMAIN_CONTROL_NAME & "_" & cst_COMMON_CONTROL_SUFFIX_GUIDE
    ...
    ByVal strMAIN_CONTROL_NAME As String _
        ...
        strRET = cst_COMMON_CONTROL_PREFIX_LABEL & strMAIN_CONTROL_NAME & "_" & cst_COMMON_CONTROL_SUFFIX_NAME
...
#Region "入力関連の補助"
    ...
    Public Sub SUB_SET_TEXT_TO_NAME_LABEL(ByRef ctlINPUT_CONTROL As System.Windows.Forms.Control, ByVal strTEXT As String)
        Dim lblNAME As System.Windows.Forms.Label

        lblNAME = FUNC_GET_CONTROL_NAME_LABEL(ctlINPUT_CONTROL)
