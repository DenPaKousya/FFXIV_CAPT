    ...
    Private Function FUNC_GET_SETTING()
        ...
        With srtCAPT_SETTINGS
            Try
                ...
                End If
                strTEMP = FUNC_GET_APP_SETTINGS(cstCONFIG_USE_JOYSTICK)
                If Not strTEMP = "" Then
                    .USE_JOYSTICK = FUNC_CAST_INT_TO_BOOL(CInt(strTEMP))
                End If
                strTEMP = FUNC_GET_APP_SETTINGS(cstCONFIG_USE_JOYSTICK_BUTTON_SCRLK)
                If Not strTEMP = "" Then
                    .USE_JOYSTICK_BUTTON_SCRLK = CInt(strTEMP)
                End If
    ...
    Private Function FUNC_SET_SETTING()
        ...
        With srtCAPT_SETTINGS
            Try
                ...
                strTEMP = CStr(FUNC_CAST_BOOL_TO_INT(.USE_JOYSTICK))
                Call FUNC_WRITE_APP_CONFIG(cstCONFIG_USE_JOYSTICK, strTEMP)
                strTEMP = CStr(.USE_JOYSTICK_BUTTON_SCRLK)
                Call FUNC_WRITE_APP_CONFIG(cstCONFIG_USE_JOYSTICK_BUTTON_SCRLK, strTEMP)
