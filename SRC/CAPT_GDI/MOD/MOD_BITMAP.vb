...
Module MOD_BITMAP
    ...
    Public Function FUNC_GET_COLOR_ARRAY(ByRef bmpBASE As Bitmap) As Byte()
        ...
        If bmpBASE Is Nothing Then
            Return Nothing
        End If
        srcBitmapData = bmpBASE.LockBits(New System.Drawing.Rectangle(0, 0, bmpBASE.Width, bmpBASE.Height), System.Drawing.Imaging.ImageLockMode.WriteOnly, bmpBASE.PixelFormat)
    ...
    Public Function FUNC_GET_IMAGESOURCE(ByRef bmpBASE As Bitmap) As System.Windows.Media.ImageSource
